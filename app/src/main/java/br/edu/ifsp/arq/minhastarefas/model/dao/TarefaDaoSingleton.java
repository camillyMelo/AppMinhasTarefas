...
public class TarefaDaoSingleton implements ITarefaDao {
    ...
    private TarefaDaoSingleton() {
        ...
        tarefaList.add(new Tarefa("Prova Redes", "23/5/2023", 2));
        tarefaList.add(new Tarefa("Projeto DMO","22/5/2023", 1));
        tarefaList.add(new Tarefa("Stop Motion IHC2", "24/5/2023", 3));
        tarefaList.add(new Tarefa("Site Web", "26/5/2023", 1));
